...
def _worker_manager_loop(in_queue, out_queue, done_event, pin_memory, device_id=None):
    # Si CUDA est disponible et que pin_memory est True, définir le bon appareil
...
def pin_memory_batch(batch):
    if isinstance(batch, torch.Tensor):
        # Épingler en mémoire uniquement si CUDA est disponible
...
class DataLoader(object):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=False, sampler=None, batch_sampler=None,
        ...
        # Désactiver la mémoire épinglée si CUDA n'est pas disponible
